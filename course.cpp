...
void addCourse(vector<Course>& courses) {
    ...
    // ===== ادخال كود المادة مع التحقق من التكرار =====
    ...
    // ===== ادخال اسم المادة كامل =====
    cout << "Enter Title: ";
    cin.ignore();
    getline(cin, c.title);

    // ===== ادخال عدد الساعات مع التحقق =====
...
void recordGrade(vector<Course>& courses, vector<Student>& students) {
    ...
    // ===== نتأكد إن الطالب ما اتسجلتلوش درجة قبل كده في نفس المادة =====
    ...
    // ===== نضيف الدرجة في الكورس =====
    c->grades.push_back({studentId, grade});

    // ===== نضيف الكورس عند الطالب لو مش مسجل فيه =====
